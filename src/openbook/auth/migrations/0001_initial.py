...
import openbook.auth.models.user
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to=openbook.auth.models.user.User._calc_file_path, verbose_name='Profile Picture')),
            ],
            options={
                'verbose_name': 'user',
