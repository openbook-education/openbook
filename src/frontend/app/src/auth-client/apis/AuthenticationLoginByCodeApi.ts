...
export interface AuthApiClientV1AuthCodeConfirmPostRequest {
    client: AuthApiClientV1AuthCodeConfirmPostClientEnum;
...
export class AuthenticationLoginByCodeApi extends runtime.BaseAPI {
     ...
     * Confirm login code
     */
    async authApiClientV1AuthCodeConfirmPostRaw(requestParameters: AuthApiClientV1AuthCodeConfirmPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthCodeConfirmPost().'
            );
        }
        ...
        if (requestParameters['confirmLoginCode'] == null) {
            throw new runtime.RequiredError(
                'confirmLoginCode',
                'Required parameter "confirmLoginCode" was null or undefined when calling authApiClientV1AuthCodeConfirmPost().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/auth/code/confirm`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
     ...
     * Confirm login code
     */
    async authApiClientV1AuthCodeConfirmPost(requestParameters: AuthApiClientV1AuthCodeConfirmPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthenticatedResponse> {
        const response = await this.authApiClientV1AuthCodeConfirmPostRaw(requestParameters, initOverrides);
     ...
     * Request login code
     */
    async authApiClientV1AuthCodeRequestPostRaw(requestParameters: AuthApiClientV1AuthCodeRequestPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthCodeRequestPost().'
            );
        }
        ...
        if (requestParameters['requestLoginCode'] == null) {
            throw new runtime.RequiredError(
                'requestLoginCode',
                'Required parameter "requestLoginCode" was null or undefined when calling authApiClientV1AuthCodeRequestPost().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/auth/code/request`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Request login code
     */
    async authApiClientV1AuthCodeRequestPost(requestParameters: AuthApiClientV1AuthCodeRequestPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
 ...
 * @export
 */
export const AuthApiClientV1AuthCodeConfirmPostClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AuthCodeConfirmPostClientEnum = typeof AuthApiClientV1AuthCodeConfirmPostClientEnum[keyof typeof AuthApiClientV1AuthCodeConfirmPostClientEnum];
/**
 * @export
 */
export const AuthApiClientV1AuthCodeRequestPostClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
