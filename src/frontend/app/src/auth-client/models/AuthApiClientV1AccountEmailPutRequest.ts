 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountEmailPutRequest
 */
...
/**
 * Check if a given object implements the AuthApiClientV1AccountEmailPutRequest interface.
 */
export function instanceOfAuthApiClientV1AccountEmailPutRequest(value: object): value is AuthApiClientV1AccountEmailPutRequest {
    if (!('email' in value) || value['email'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountEmailPutRequestFromJSON(json: any): AuthApiClientV1AccountEmailPutRequest {
    return AuthApiClientV1AccountEmailPutRequestFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailPutRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountEmailPutRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountEmailPutRequestToJSON(json: any): AuthApiClientV1AccountEmailPutRequest {
    return AuthApiClientV1AccountEmailPutRequestToJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailPutRequestToJSONTyped(value?: AuthApiClientV1AccountEmailPutRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
